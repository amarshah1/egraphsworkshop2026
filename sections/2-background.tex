...
as integer and real arithmetic, algebraic datatypes, and quantifiers. 
...
solver's data structures must be rolled back to the state they were in before the first
disjunct.
...
Then the query scheduler can choose to start from either atom. Starting from the
