...
executor with greedy query planning, semi-naive evaluation, and deduplication.
...
cloning is $O(1)$ --- it shares structure with the live copy. On backtrack, the
...
permanent in the egraph even though the equalities that triggered them may have
been undone.
