...
\begin{abstract}
E-matching is the problem of finding all matches of a pattern in an e-graph.
...
decisions. We provide an initial implementation of a backtrackable, relational
...
set of synthetic benchmarks and show a median speedup of $25 \times$ over a
top-down e-matching algorithm. However, when considering a set of
